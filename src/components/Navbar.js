      ...
      <header className="">
        ...
        <h2 className="font-bold text-xl">Create Flashcard</h2>
          <div className="flex justify-start mt-4">
            <div className="m-4 text-gray-400 border-b-2 rounded-sm p-[5px] border-red-500">Create New</div>
            <div className="m-4 text-gray-400 border-b-2 rounded-sm p-[5px]">My Flashcard</div>
          </div>
        </div>
      </header>
    </>
