    ...
    <>
      ...
      <div className="terms TermMain relative bg-white shadow-md mt-4 ml-24 w-3/4 border-2 rounded p-4">
        <div id="TermsContainer" className="flex items-start gap-6">
          ...
          {/* Definition */}
          <div className="flex flex-col">
            <label className="mb-1 text-gray-400">Enter Definition*</label>
            <textarea className="border border-gray-300 p-2 rounded w-80 h-20 resize-none"></textarea>
          </div>
      ...
      <div className="flex justify-center items-center m-4">
        <button className="bg-red-600 text-white rounded p-1 w-24">Create</button>
      </div>
    </>
  );
};
